...
public abstract class WheelVelocityController extends VelocityController {
   ...
   **/
  protected static final double MAX_ANGULAR_VELOCITY=15.0/11 * 2*Math.PI;
   ...
   **/
  protected static final double WHEEL_RADIUS_IN_M=0.063;
   ...
   **/
  protected static final double TICKS_PER_REVOLUTION=GEAR_RATIO*ENCODER_RESOLUTION;
  ...
  public double computeRadiansPerTick() {
    ...
    // Start Student Code
    result = Math.PI*2/this.TICKS_PER_REVOLUTION;
    // End Student Code
    return result;
  }
  ...
  public double computeEncoderInRadians() {
    double result = 0;
    result = computeRadiansPerTick()*this.encoderTicks;
    return result;
  }
  ...
  public double computeAngularVelocity() {
	...
	// Start Student Code
    	//radians compyuted from encoder ticks/sampletime
  ...
  public double computeTranslationalVelocity() {
	...
	// Start Student Code
    	//translational velocity = angular velocity * wheel radius
    	result=computeAngularVelocity()*this.WHEEL_RADIUS_IN_M;
	// End Student Code
    }       
    return result;
  }
